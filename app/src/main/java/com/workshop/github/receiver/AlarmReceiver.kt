package com.workshop.github.receiver
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    private fun sendNotification(context: Context) {
        ...
        val intent = context.packageManager.getLaunchIntentForPackage("com.workshop.github")
    ...
    fun setReoeatingAlarm(context: Context, type: String, time: String, message: String){
    ...
    fun cancelAlarm(context: Context){
        ...
        Toast.makeText(context, "Repeating Alarm Is Cancel", Toast.LENGTH_SHORT).show()
    }
